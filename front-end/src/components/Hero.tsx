...
import taroOutlineImg from '../assets/images/taroOutline.jpg';
import taroLongStemImg from '../assets/images/taroLongStem.jpg';
  ...
  return (
    <div className='hero'>
      <div className="heroWrapper">
        ...
        <img className="taroImg2" src={taroLongStemImg}></img>
        <img className="taroImg" src={taroLongStemImg}></img>
      </div>
    </div>
  )
}
