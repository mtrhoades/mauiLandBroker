    ...
    <div className='footer'>
      <div className="footerWrapper">
          <div className='summaryDiv'>
            ...
            <p>We here at MLB strive to keep the culture of Maui alive and well. Our roots run deep here and we want nothing more than to preserve the communities of Maui that have been here since the beginning.</p>
          </div>
